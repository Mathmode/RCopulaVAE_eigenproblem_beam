...
from MODULES.COPULAS.GC_GMm_architectures import Fully_connected_enc_GC, Copula_pdf_layer
...
class My_CopulaVAE_withEigen(tf.keras.Model):
    ...
    def Alpha_regularizer(self, y_true, y_pred):
        # y_pred is reshaped_alpha_samples here
    ...
    def ELBO_Copula_loss(self, y_true, y_pred):
        ...
        # y_pred is the alphas output from call()
        Regularizer = self.Alpha_regularizer(y_true, y_pred)
        
        ELBO_loss = Loss_freqs + 10*Loss_MAC - Regularizer + Joint_copula_nll
